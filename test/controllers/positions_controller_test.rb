...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference("Position.count") do
      post positions_url, params: { position: { latitude: @position.latitude, longitude: @position.longitude } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { latitude: @position.latitude, longitude: @position.longitude } }
